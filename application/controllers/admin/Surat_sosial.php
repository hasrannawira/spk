...
class Surat_sosial extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layouts/template', 'admin/surat_sosial', $data);
    }
    ...
    public function hapus(){
        ...
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Menghapus Surat Seksi Stat. Sosial '.$nomor_surat,
        );
        $this->m_aktivitas->input_data($aktivitas);
        redirect ('admin/surat_sosial');
    }
    ...
    public function edit($id_surat){
        ...
        $this->template->load('layouts/template', 'admin/edit_surat_sosial', $data);        
    }
    ...
    public function update(){
        ...
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Mengupdate Surat Seksi Stat. Sosial '.$nomor_surat,
        );
