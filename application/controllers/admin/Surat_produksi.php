...
class Surat_produksi extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layouts/template', 'admin/surat_produksi', $data);
    }
    ...
    public function hapus(){
        ...
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Menghapus Surat Seksi Stat. Produksi '.$nomor_surat,
        );
        $this->m_aktivitas->input_data($aktivitas);
        redirect ('admin/surat_produksi');
    }
    ...
    public function edit($id_surat){
        ...
        $this->template->load('layouts/template', 'admin/edit_surat_produksi', $data);        
    }
    ...
    public function update(){
        ...
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Mengupdate Surat Seksi Stat. Produksi '.$nomor_surat,
        );
