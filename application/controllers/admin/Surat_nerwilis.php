...
class Surat_nerwilis extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('layouts/template', 'admin/surat_nerwilis', $data);
    }
    ...
    public function edit($id_surat){
        ...
        $this->template->load('layouts/template', 'admin/edit_surat_nerwilis', $data);        
    }
