...
class Surat_tu extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['surat'] = $this->m_surat_tu->tampil_data()->result();
        $this->template->load('layouts/member/template', 'member/surat_tu', $data);
    }
    ...
    public function tambah_surat(){
        ...
        $nomor_surat = 'B-'.$no_urut.'/'.$id_instansi.$kode_satker.'/'.$instansi_asal.'/'.$id_bulan.'/'.$tahun;
            ...
            $this->m_surat_tu->input_data($data);
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Menambahkan Surat Seksi TU '.$nomor_surat,
        );
        $this->session->set_flashdata('flash','Surat TU Berhasil Ditambahkan');
        $this->m_aktivitas->input_data($aktivitas);
            redirect('member/surat_tu');
        } else{
            redirect('member/surat_tu');            
        }
    }
    ...
    public function hapus(){
        ...
        $this->m_surat_tu->hapus_data($where,'tbl_surat_tu');
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Menghapus Surat Seksi TU '.$nomor_surat,
        );
        $this->m_aktivitas->input_data($aktivitas);
        redirect ('member/surat_tu');
    }
    ...
    public function edit($id_surat){
        ...
        $this->template->load('layouts/member/template', 'member/edit_surat_tu', $data);        
    }
    ...
    public function update(){
        ...
        $this->m_surat_tu->update_data($where,$data);
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Mengupdate Surat Seksi TU '.$nomor_surat,
        );
        $this->session->set_flashdata('flash','Surat TU Berhasil Diupdate');
        $this->m_aktivitas->input_data($aktivitas);
        redirect('member/surat_tu');
        } else{
        $data = konfigurasi('Dashboard');
    ...
    public function upload_file(){
        ...
        if ($file=''){
                ...
                $config['upload_path']          = './assets/uploads/surat_tu/';
        ...
        $aktivitas = array(
                'username'           =>  $this->session->userdata('username'),
                'aktivitas'         =>  'Mengunggah Surat Seksi TU',
        );
        $this->session->set_flashdata('flash','Surat TU Berhasil Diunggah');
        $this->m_surat_tu->update_data($where,$data);
        $this->m_aktivitas->input_data($aktivitas);
        redirect('member/surat_tu');
    }
