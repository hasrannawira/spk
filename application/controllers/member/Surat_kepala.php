...
class Surat_kepala extends MY_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->check_login();
        if ($this->session->userdata('id_role') != "2" or $this->session->userdata('id_satker') != "0") {
            redirect('', 'refresh');
        }
    }
    ...
    public function index()
    {
        ...
        $this->template->load('layouts/member/template', 'member/surat_kepala', $data);
    }
    ...
    public function edit($id_surat){
        ...
        $this->template->load('layouts/member/template', 'member/edit_surat_kepala', $data);        
    }
