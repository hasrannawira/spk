      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td><?php echo anchor('admin/surat_ipds/edit/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></div>') ?></td>
            <td><?php echo anchor('admin/export_doc/export_nomor_surat_ipds/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-file"></i></div>') ?></td>
            <td>
              <?php if($srt->is_upload=='0'){
              echo form_open_multipart("admin/surat_ipds/upload_file");             
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('admin/surat_ipds/tambah_surat'); ?>
