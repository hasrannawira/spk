      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td><a class="tombol_hapus" href="<?php echo 'surat_sp2020/hapus/'.$srt->id_surat.'/'.$nomor_surat ?>"><div class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i></div></a></td>
            <td><?php echo anchor('admin/surat_sp2020/edit/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></div>') ?></td>
            <td><?php echo anchor('admin/export_doc/export_nomor_surat_sp2020/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-file"></i></div>') ?></td>
            <td>
              <?php if($srt->is_upload=='0'){
              echo form_open_multipart("admin/surat_sp2020/upload_file");             
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('admin/surat_sp2020/tambah_surat'); ?>
