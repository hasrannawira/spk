<div class="conten-wrapper">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Surat Seksi TU</li>
      </ol>
    </section>
      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td><a class="tombol_hapus" href="<?php echo 'surat_tu/hapus/'.$srt->id_surat.'/'.$nomor_surat ?>"><div class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i></div></a></td>
            <td><?php echo anchor('member/surat_tu/edit/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></div>') ?></td>
            <td><?php echo anchor('member/export_doc/export_nomor_surat_tu/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-file"></i></div>') ?></td>
            <td>
              <?php if($srt->is_upload=='0'){
              echo form_open_multipart("member/surat_tu/upload_file");             
              echo '<input type="file" name="file" >
              <input type="hidden" name="id_surat" value="'.$srt->id_surat.'">
              <button type="submit" class ="btn btn-primary btn-sm">Upload</button>';
              echo form_close();
              } else{
                echo '<a class="tombol_unduh" href="'.base_url().'assets/uploads/surat_tu/'.$srt->file.'"><div class="btn btn-primary btn-sm"> <i class="fa fa-cloud-download"></i></div></a>';
              }?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('member/surat_tu/tambah_surat'); ?>
    ...
    <div class="form-group">
      ...
      <select name="kode_satker" class="form-control">
        <option value="1" selected>Seksi Tata Usaha</option>
      </select>    
    </div>    
    <div class="form-group">
      <label>Tanggal</label>
