<div class="content-wrapper">
	...
	<section class="content">
		...
		<form action="<?php echo base_url().'member/surat_distribusi/update'; ?>" method="post">
		    ...
		    <div class="form-group">
		      ...
		      <select name="kode_satker" class="form-control">
		        <option value="4" <?php if ($srt->kode_satker == "4") echo 'selected'; ?>>Seksi Statistik Distribusi</option>
		      </select>
