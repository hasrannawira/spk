<div class="content-wrapper">
	...
	<section class="content">
		...
		<form action="<?php echo base_url().'member/surat_kepala/update'; ?>" method="post">
		    ...
		    <div class="form-group">
		      ...
		      <select name="kode_satker" class="form-control">
		        <option value="0" <?php if ($srt->kode_satker == "0") echo 'selected'; ?>>Kepala BPS Kabupaten/Kota</option>
		      </select>
