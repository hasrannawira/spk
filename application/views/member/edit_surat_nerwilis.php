<div class="content-wrapper">
	...
	<section class="content">
		...
		<form action="<?php echo base_url().'member/surat_nerwilis/update'; ?>" method="post">
		    ...
		    <div class="form-group">
		      ...
		      <select name="kode_satker" class="form-control">
		        <option value="5" <?php if ($srt->kode_satker == "5") echo 'selected'; ?>>Seksi Nerwilis</option>
		      </select>
