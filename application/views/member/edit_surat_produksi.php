<div class="content-wrapper">
	...
	<section class="content">
		...
		<form action="<?php echo base_url().'member/surat_produksi/update'; ?>" method="post">
		    ...
		    <div class="form-group">
		      ...
		      <select name="kode_satker" class="form-control">
		        <option value="3" <?php if ($srt->kode_satker == "3") echo 'selected'; ?>>Seksi Statistik Produksi</option>
		      </select>
