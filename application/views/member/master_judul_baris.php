          ...
          <div class="box box-info">
    		...
    		foreach ($judul_baris as $jdl) : ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo anchor('member/KCA/edit_judul_baris/'.$jdl->id_nama_judul_baris,'<div class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></div>') ?></td>
                  </tr>
    		 <?php endforeach; ?>
                  </tbody>
                </table>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <?php echo form_open_multipart('member/KCA/tambah_judul_baris'); ?>
