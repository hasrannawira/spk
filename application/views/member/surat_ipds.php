      ...
      <table class="table">
        ...
        ?>
          <tr>
            ...
            <td><a class="tombol_hapus" href="<?php echo 'surat_ipds/hapus/'.$srt->id_surat.'/'.$nomor_surat ?>"><div class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i></div></a></td>
            <td><?php echo anchor('member/surat_ipds/edit/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></div>') ?></td>
            <td><?php echo anchor('member/export_doc/export_nomor_surat_ipds/'.$srt->id_surat,'<div class="btn btn-primary btn-sm"> <i class="fa fa-file"></i></div>') ?></td>
            <td>
              <?php if($srt->is_upload=='0'){
              echo form_open_multipart("member/surat_ipds/upload_file");             
              echo '<input type="file" name="file" >
              <input type="hidden" name="id_surat" value="'.$srt->id_surat.'">
              <button type="submit" class ="btn btn-primary btn-sm">Upload</button>';
              echo form_close();
              } else{
                echo '<a class="tombol_unduh" href="'.base_url().'assets/uploads/surat_ipds/'.$srt->file.'"><div class="btn btn-primary btn-sm"> <i class="fa fa-cloud-download"></i></div></a>';
              }?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel" align="center"><b>FORM INPUT SURAT SEKSI STATISTIK IPDS</b></h4>
      ...
      <?php echo form_open_multipart('member/surat_ipds/tambah_surat'); ?>
    ...
    <div class="form-group">
      ...
      <select name="kode_satker" class="form-control">
        <option value="6" selected>Seksi IPDS</option>
      </select>    
    </div>    
    <div class="form-group">
      <label>Tanggal</label>
